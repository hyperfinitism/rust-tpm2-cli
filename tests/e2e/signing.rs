...
mod signature_verification {
    ...
    #[test]
    fn e2e_verifysignature_corrupted_signature_fails() {
        let setup = SignSetup::new();
        let sig = setup.session.tmp().path().join("sig_rsa.bin");
        setup
            .session
    ...
    #[test]
    fn e2e_verifysignature_ecc_sig_with_rsa_key_fails() {
        let setup = SignSetup::new();
    ...
    #[test]
    fn e2e_verifysignature_with_external_key_file() {
        let setup = SignSetup::new();
        let sig = setup.session.tmp().path().join("sig_rsa.bin");
        setup
            .session
    ...
    #[test]
    fn e2e_verifysignature_with_message() {
        let setup = SignSetup::new();
        let sig = setup.session.tmp().path().join("sig_rsa.bin");
        setup
            .session
    ...
    #[test]
    fn e2e_verifysignature_with_message_default_hash() {
    ...
    #[test]
    fn e2e_verifysignature_wrong_digest_fails() {
        let setup = SignSetup::new();
        let sig = setup.session.tmp().path().join("sig_rsa.bin");
        setup
            .session
    ...
    #[test]
    fn e2e_verifysignature_wrong_key_fails() {
        let setup = SignSetup::new();
        let sig = setup.session.tmp().path().join("sig_rsa.bin");
        setup
            .session
