...
//! End-to-end tests for sequence.

mod hash_sequence {
    use crate::common::SwtpmSession;

    #[test]
    fn e2e_hash_sequence_multiple_updates() {
    ...
    #[test]
    fn e2e_hash_sequence_produces_ticket() {
        let s = SwtpmSession::new();
    ...
    #[test]
    fn e2e_hash_sequence_with_final_data_in_complete() {
        let s = SwtpmSession::new();
...
mod hmac_sequence {
    ...
    #[test]
    fn e2e_hmac_sequence_matches_single_hmac() {
        let s = SwtpmSession::new();
