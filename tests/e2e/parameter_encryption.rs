...
//! End-to-end tests for parameter encryption.

mod encrypted_session_roundtrip {
    use crate::common::SwtpmSession;

    #[test]
    fn e2e_parameter_encryption_getrandom() {
    ...
    #[test]
    fn e2e_parameter_encryption_nvwrite_nvread_roundtrip() {
        let s = SwtpmSession::new();
